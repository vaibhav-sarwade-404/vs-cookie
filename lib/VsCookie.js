...
var VsCookie = /** @class */ (function () {
    ...
    VsCookie.getCookie = function (cookies, cookieName, options) {
        ...
        var cookie = Array.isArray(cookieNameValuePair)
            ...
            : "";
        var _separator = (options === null || options === void 0 ? void 0 : options.separor) || separator;
        if (secret) {
    ...
    VsCookie.sign = function (cookie, secret, options) {
        ...
        if (cookie.includes(_seperate)) {
            throw new TypeError("cookie value cannot conatain separator(".concat(_seperate, ")."));
        }
        return encode("".concat(cookie).concat(_seperate).concat(VsCookie.hash(cookie, secret)));
    };
    /**
     *
