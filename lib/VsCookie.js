...
var VsCookie = /** @class */ (function () {
    ...
    VsCookie.createCookie = function (cookieOption) {
        ...
        maxAge && cookie.push("Max-Age=".concat(maxAge));
     ...
     *
     */
    VsCookie.sign = function (cookie, secret) {
        ...
        return "".concat(cookie, ".").concat(VsCookie.hash(cookie, secret));
    };
    /**
     *
     ...
     * @throws {TypeError | Error}
     */
    VsCookie.verify = function (cookie, secret) {
        if (typeof cookie !== "string" || !cookie) {
            throw new TypeError("cookie should be a valid string");
        }
        if (typeof secret !== "string" || !secret) {
        ...
        var _a = __read(cookie.split("."), 2), originalCookieVal = _a[0], originalCookieHash = _a[1];
